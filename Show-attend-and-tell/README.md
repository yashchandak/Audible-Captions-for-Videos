...
Set-up data folder as given by the [Yujney's branch](https://github.com/yunjey/show-attend-and-tell/network) 

### Download the pretrained model from [Here](https://drive.google.com/open?id=0B4fD_TiC7i0fLWhqV1IweDhrTXM) and unzip it in ./model/
